...
<html>
  ...
  <body>
    ...
    <form method="post" id="post">
      ...
      <div>
        <input type="text" name="nim" placeholder="NIM" required maxlength="10"><br><br>
      </div>
      <div>
        <input type="radio" name="method" value="Post" checked>Post
      </div>
      <div>
        <input type="radio" name="method" value="Get" onclick="document.getElementById('post').method='get'">Get<br><br>
      </div>
      <div>
