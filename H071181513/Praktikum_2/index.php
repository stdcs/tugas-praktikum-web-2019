                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    ...
                                    <form action="pages/action.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input class="form-control form-control-user" type="number" name="income" placeholder="Penghasilan Orang Tua" required>
                                        </div>
                                        <div class="form-group">
                                            <button class="btn btn-block btn-user btn-primary" type="submit" name="btn-submit"><i class="fa fa-upload"></i> Submit</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
