            ...
            <div class="col-lg-7">
                <div class="card border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        $name = $_POST['name'];
                        $ipk = $_POST['ipk'];
                        $saudara = $_POST['sibling'];
                        $penghasilan = $_POST['income'];
                        if ($ipk < 3.5 || $saudara < 5 || $penghasilan > 2000000) {
                            echo '<div class="card-header bg-danger text-center"><h1 class="h4 text-white p-2 mb-1"><i class="fa fa-warning"></i> Maaf</h1></div>';
                        } else {
                            echo '<div class="card-header bg-primary text-center"><h1 class="h4 text-white p-2 mb-1"><i class="fa fa-check-circle"></i> Selamat</h1></div>';
                        }
                        ?>
