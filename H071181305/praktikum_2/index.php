                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    ...
                                    <form action="pages/action.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input class="form-control form-control-user" type="number" name="ipk" min="0" max="4"
                                            ng-model="interval" placeholder="Nilai IPK" min="0.0" max="4.0" step="any" required>
                                            <select ng-model= "freqValue" ng-options= "f.key as f.value for f in fareq"></select>
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control form-control-user" type="number" name="sibling" min="0" max=" "placeholder="Jumlah Saudara" required >
                                        </div>
                                        <div class="form-group">
